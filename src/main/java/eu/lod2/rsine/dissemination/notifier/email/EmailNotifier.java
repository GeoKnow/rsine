...
public class EmailNotifier implements INotifier {
  ...
  private String emailAddress, from, host, port, subject = "[WP5] Notification", username,
      password;
  ...
  private Session createSession() {
    return Session.getInstance(createMailProperties(), new javax.mail.Authenticator() {
